...
public class ListaEncadeada {
    ...
    public void removeInicio() throws Exception {
        ...
        cabeca.proximo = cabeca.proximo.proximo; //o primeiro aponta pro segundo, cabeca.proximo é o primeiro e o cabeca.proximo.proximo é o segundo
    ...
    public void print() {
        No el = cabeca.proximo;
        while (el != null) {
            System.out.println("Nome: " + el.elemento.nome + "| " + "Idade: " + el.elemento.idade);

            el = el.proximo;
        }
    }
    public void printAoContrario(){
        No el = cauda;
